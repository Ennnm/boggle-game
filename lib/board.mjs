const boardSize = 16;
export const numCol = Math.sqrt(boardSize);
export const numRow = Math.sqrt(boardSize);
...
export const convertBoardStrToArr2 = (str) => {
  const arr1 = convertBoardStrToArr1(str);
  const arr2 = convertArr1ToSquareArr(arr1);
  return arr2;
};
